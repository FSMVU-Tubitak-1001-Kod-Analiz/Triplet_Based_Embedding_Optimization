...
if __name__ == '__main__':
    ...
    parser.add_argument("-ep", "--embeds_path")
    parser.add_argument("-lp", "--label_path")
    parser.add_argument("-op", "--optimizer")
    parser.add_argument("-bs", "--batch_size", type=int)
    parser.add_argument("-sr", "--smell_range", type=_build_smell_range)
    parser.add_argument("-lr", "--learning_rate", type=_build_lr)
    parser.add_argument("-sh", "--shuffle", type=_to_shuffle)
